...
import { ILocation } from './selection';
...
export type carType = {
  ...
  id: string;
  name: string;
  typeBusiness: 'popular' | 'recommend' | 'all';
  type: string;
  imgSm?: string;
  imgLg?: string;
  gas: string;
...
export const listAllCar: carType[] = [
  {
    ...
    pickDate: ['2023-03-26', '2023-03-26', '2023-03-27', '2023-03-28'],
    pickTime: ['1:00', '1:30', '2:00', '2:30', '3:00', '3:30', '4:00'],
    dropLocation: [
      { id: '1', value: 'District 1' },
      { id: '2', value: 'District 2' },
      { id: '3', value: 'District 3' },
    ...
    dropDate: ['2023-03-25', '2023-03-26', '2023-03-27', '2023-03-28'],
    dropTime: ['1:00', '1:30', '2:00', '2:30', '3:00', '3:30', '4:00'],
  },
  {
    typeBusiness: 'popular',
    id: '2',
    ...
    pickDate: ['2023-03-25', '2023-03-26', '2023-03-27', '2023-03-28'],
    pickTime: ['1:00', '1:30', '2:00', '2:30', '3:00', '3:30', '4:00'],
    dropLocation: [
      { id: '1', value: 'District 1' },
      { id: '2', value: 'District 2' },
