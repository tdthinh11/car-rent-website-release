      ...
      <div className="wrapper px-6 pb-6 md:px-16 md:pt-20 md:pb-14">
        <div className="lg:flex lg:items-start">
          ...
          <div className="flex flex-wrap justify-between gap-12 lg:grow lg:basis-0 lg:gap-0">
            <div>
              <h2 className="text-black-2 mb-4 text-xl font-semibold leading-[150%]">About</h2>
            ...
            <div>
              <h2 className="text-black-2 mb-4 text-xl font-semibold leading-[150%]">Socials</h2>
              <div className="flex flex-col">
            ...
            <div>
              <h2 className="text-black-2 mb-4 text-xl font-semibold leading-[150%]">Community</h2>
              <div className="flex flex-col">
